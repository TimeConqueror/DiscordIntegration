...
//                DiscordIntegrationLogger.debug(e);
//                return;
//            }
//            DiscordIntegrationLogger.error(e);
//        } catch (Throwable t) {
//            DiscordIntegrationLogger.error(t);
//        }
//    }
//
    /**
...
//
    ...
    public static String stripLegacy(String text) {
        if (StringUtils.isBlank(text)) {
            DiscordIntegrationLogger.debug("Tried stripping blank message");
            return "";
        }
