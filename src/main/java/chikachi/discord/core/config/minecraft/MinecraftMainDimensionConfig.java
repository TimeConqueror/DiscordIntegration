...
public class MinecraftMainDimensionConfig {
    @Since(3.0)
    public chikachi.discord.core.config.minecraft.MinecraftGenericConfig generic = new chikachi.discord.core.config.minecraft.MinecraftGenericConfig();
    @Since(3.0)
    public HashMap<Integer, chikachi.discord.core.config.minecraft.MinecraftDimensionConfig> dimensions = new HashMap<>();

    public chikachi.discord.core.config.minecraft.MinecraftDimensionConfig getDimension(int dimension) {
